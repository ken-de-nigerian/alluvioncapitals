        ...
        <div class="offcanvas-lg offcanvas-start sticky-lg-top pe-lg-0 pe-xl-4" id="accountSidebar">
            ...
            <div class="offcanvas-body d-block pt-2 pt-lg-4 pb-lg-0">
                <nav class="list-group list-group-borderless">
                    <Link class="list-group-item list-group-item-action d-flex align-items-center rounded-pill" :class="{ 'active': page.component === 'User/Index' }" :href="route('user.dashboard')">
                        <i class="ci-grid fs-base opacity-75 me-2"></i>
                        Dashboard
                    </Link>

                    <Link class="list-group-item list-group-item-action d-flex align-items-center rounded-pill" :class="{ 'active': ['User/Campaign', 'User/Rewards', 'User/Updates', 'User/Comments'].some(prefix => page.component.startsWith(prefix)) }" :href="route('user.campaigns.index')">
                        <i class="ci-gift fs-base opacity-75 me-2"></i>
                        Campaigns ({{ page.props.allUserCampaignCount }})
                    </Link>

                    <Link class="list-group-item list-group-item-action d-flex align-items-center rounded-pill" :class="{ 'active': page.component.startsWith('User/Donations') }" :href="route('user.payments.donations')">
                ...
                <nav class="list-group list-group-borderless">
                    <Link class="list-group-item list-group-item-action d-flex align-items-center rounded-pill" :class="{ 'active': page.component.startsWith('User/Withdrawals') }" :href="route('user.payments.withdrawals')">
                ...
                <nav class="list-group list-group-borderless">
                    <Link class="list-group-item list-group-item-action d-flex align-items-center rounded-pill" :class="{ 'active': page.component.startsWith('User/Profile') }" :href="route('user.profile')">
