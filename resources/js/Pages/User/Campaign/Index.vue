<script setup lang="ts">
    ...
    const performSearch = debounce(() => {
        router.get(route('user.campaigns.index'), { search: search.value }, {
            preserveState: true,
            replace: true,
            preserveScroll: true
        });
    ...
    const bulkArchive = () => {
        ...
        confirmAction("Are you sure you want to archive the selected items?", () => {
            router.post(route('user.campaigns.archive'), { ids: selectedItems.value }, {
                preserveScroll: true,
                onSuccess: () => {
                    selectedItems.value = [];
    ...
    const bulkDelete = () => {
        ...
        confirmAction("Are you sure you want to delete the selected items? This action cannot be undone.", () => {
            router.delete(route('user.campaigns.destroy'), {
    ...
    const markAsComplete = () => {
        ...
        confirmAction("Ending this campaign is final and cannot be undone. Do you wish to continue?", () => {
            router.post(route('user.campaigns.complete'), {
...
<template>
    ...
    <div class="col-lg-9">
        ...
        <div class="overflow-auto mb-3">
            <ul class="nav nav-pills flex-nowrap gap-2 text-nowrap pb-3" role="tablist">
                <li class="nav-item" role="presentation">
                    <Link :href="route('user.campaigns.index')" :class="{ 'active': page.component === 'User/Campaign/Index' }" class="nav-link">
                ...
                <li class="nav-item" role="presentation">
                    <Link :href="route('user.campaigns.archived')" :class="{ 'active': page.component === 'User/Campaign/Archived' }" class="nav-link">
        ...
        <div class="tab-content">
            <div class="tab-pane fade" :class="{ 'show active': page.component === 'User/Campaign/Index' }">
                <!-- Loading state -->
