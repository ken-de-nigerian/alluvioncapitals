<script setup lang="ts">
    ...
    const performSearch = debounce(() => {
        router.get(route('user.campaigns.archived'), { search: search.value }, {
            preserveState: true,
            replace: true,
            preserveScroll: true
        });
    ...
    const bulkArchive = () => {
        ...
        confirmAction("Are you sure you want to restore the selected items?", () => {
            router.post(route('user.campaigns.restore'), { ids: selectedItems.value }, {
                preserveScroll: true,
                onSuccess: () => {
                    selectedItems.value = [];
...
<template>
    ...
    <div class="col-lg-9">
        ...
        <div class="tab-content">
            <div class="tab-pane fade" :class="{ 'show active': page.component === 'User/Campaign/Archived' }">
                <!-- Loading state -->
