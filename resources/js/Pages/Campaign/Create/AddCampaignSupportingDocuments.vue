<script setup lang="ts">
    ...
    const existingDocuments = ref(
        Array.isArray(props.documents?.supporting_documents)
            ? props.documents.supporting_documents.map(item => ({
    ...
    // Submit form
    const submit = () => {
        form.post(route('campaigns.add.supporting.documents.store'), {
            preserveScroll: true,
            forceFormData: true,
            onError: (errors) => {
...
<template>
                ...
                <aside class="col-lg-3 col-xl-4 mb-3" style="margin-top: -100px">
                    <div class="sticky-top overflow-y-auto" style="padding-top: 100px">
                        <ul class="nav flex-lg-column flex-nowrap gap-4 gap-lg-0 text-nowrap pb-2 pb-lg-0">
                            ...
                            <li class="nat-item">
                                <Link class="nav-link d-inline-flex position-relative px-0 px-lg-3" :href="route('campaigns.add.photos.videos')">
                                    <i class="ci-check-circle fs-lg me-2"></i>
    ...
    <footer class="sticky-bottom bg-body pb-3">
        ...
        <div class="container d-flex gap-3 pt-3">
            <Link class="btn btn-outline-dark animate-slide-start" :href="route('campaigns.add.photos.videos')">
