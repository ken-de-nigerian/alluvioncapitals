...
import {Head, router, usePage} from "@inertiajs/vue3";
    ...
    const deleteComment = (comment: Comment) => {
        confirmAction("Deleting this comment is final and cannot be undone. Do you wish to continue?", () => {
            router.delete(route('admin.campaigns.comments.delete', [props.campaign.id, comment.id]), {
                preserveScroll: true,
            });
        });
    };
        ...
        <template v-if="props.comments.data.length > 0">
            ...
            <div v-for="comment in props.comments.data" :key="comment.id" class="list-group mb-3">
                <div class="list-group-item position-relative">
                    ...
                    <!-- Delete button floated to right -->
                    <div class="d-flex justify-content-end">
                        <button type="button" class="nav-link text-body-secondary animate-scale px-0 ms-n1" @click="deleteComment(comment)">
