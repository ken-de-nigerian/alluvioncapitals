<script setup lang="ts">
    ...
    const deleteUpdate = (update: Update) => {
        confirmAction(
            ...
            () => {
                router.delete(
                    route("admin.campaigns.updates.delete", [props.campaign.id, update.id]),
                    {
                        preserveScroll: true,
                    }
                );
...
<template>
    ...
    <div class="col-lg-9 pt-2 pt-xl-3">
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <Link :href="route('admin.campaigns.updates.add', campaign.id)" class="btn btn-secondary ms-auto">
        ...
        <template v-if="props.updates.data.length > 0">
            ...
            <div v-for="update in props.updates.data" :key="update.id" class="border-bottom py-3 mb-3">
                ...
                <div class="nav align-items-center">
                    <Link :href="route('admin.campaigns.updates.edit', update.id)" class="nav-link text-body-secondary animate-scale px-0 ms-auto me-n1">
