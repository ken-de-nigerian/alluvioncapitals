<script setup lang="ts">
    ...
    const uploadFile = (file) => {
        ...
        router.post(route('admin.picture.update'),
            { profile_image: file },
            {
                preserveScroll: true,
                forceFormData: true,
    ...
    const removeProfilePicture = () => {
        router.delete(route('admin.picture.remove'), {
            preserveScroll: true,
            onSuccess: () => {
...
<template>
    ...
    <div class="col-lg-9 pt-2 pt-xl-3">
        ...
        <div class="tab-content">
            <!-- Profile tab -->
            <div class="tab-pane fade" :class="{ 'show active': page.component === 'Admin/Profile/Index' }">
