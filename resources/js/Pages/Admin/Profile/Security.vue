<script setup lang="ts">
    ...
    const submit = () => {
        form.patch(route('admin.password.update'), {
            ...
            onError: () => {
                // Clear only new passwords (keep current password)
    ...
    // Clear current_password errors when input changes
    watch(() => form.current_password, () => {
        if (form.errors.current_password) form.clearErrors('current_password')
    })

    // Clear password_confirmation errors when input changes
...
<template>
    ...
    <div class="col-lg-9 pt-2 pt-xl-3">
        ...
        <div class="tab-content">
            <!-- Security tab -->
            <div class="tab-pane fade" :class="{ 'show active': page.component === 'Admin/Profile/Security' }">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 g-4 mb-4">
                        <div class="col">
                            ...
                            <div class="password-toggle">
                                ...
                                <div v-if="form.errors.current_password" class="invalid-tooltip bg-transparent py-0">{{ form.errors.current_password }}</div>
