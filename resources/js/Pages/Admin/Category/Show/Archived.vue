<script setup lang="ts">
    ...
    const performSearch = debounce(() => {
        router.get(route('admin.categories.show.archived', props.category.slug), { search: search.value }, {
            preserveState: true,
            replace: true,
            preserveScroll: true
        });
...
<template>
    ...
    <div class="col-lg-9">
        ...
        <div class="tab-content">
            <div class="tab-pane fade" :class="{ 'show active': page.component === 'Admin/Category/Show/Archived' }">
                <!-- Loading state -->
