<script setup lang="ts">
    ...
    const bulkArchive = () => {
        ...
        confirmAction("Are you sure you want to archive the selected items?", () => {
            router.post(route('admin.categories.archive'), { ids: selectedItems.value }, {
                preserveScroll: true,
                onSuccess: () => {
                    selectedItems.value = [];
...
<template>
    ...
    <div class="col-lg-9 pt-2 pt-xl-3">
        ...
        <div class="tab-content">
            <!-- Profile tab -->
            <div class="tab-pane fade" :class="{ 'show active': page.component === 'Admin/Category/Index' }">
                    ...
                    <table class="table align-middle fs-sm mb-0">
                        ...
                        <tbody class="product-list">
                            <tr v-for="category in categories.data" :key="category.id">
                                ...
                                <td class="d-md-table-cell py-3">
                                    <Link :href="route('admin.categories.edit', category.id)" class="btn btn-sm bg-info-subtle"><i class="ci-edit-3 me-2"></i> Edit</Link>
                                </td>
                            </tr>
