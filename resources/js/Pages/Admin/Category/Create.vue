...
<template>
    ...
    <div class="col-lg-9 pt-2 pt-xl-3">
        ...
        <!-- Page title -->
        <h1 class="h2 pb-1 pb-sm-2 pb-md-3">Add Category</h1>
        ...
        <form @submit.prevent="submit">
            <div class="d-flex align-items-start align-items-sm-center pb-3 mb-3">
                <div class="ratio ratio-1x1 hover-effect-opacity overflow-hidden" style="width: 112px">
                    <img id="preview-category" src="https://placehold.co/124x124/222934/ffffff?text=C" class="img-fluid mb-3 rounded" style="max-height: 120px; width: auto;" alt="Category Image" loading="lazy">
                </div>
