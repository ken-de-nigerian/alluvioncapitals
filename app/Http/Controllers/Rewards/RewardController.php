...
class RewardController extends Controller
{
    ...
    public function store(Request $request, Campaign $campaign): RedirectResponse
    {
        ...
        try {
            ...
            return redirect()
                ->route('admin.campaigns.rewards.index', $campaign->id)
    ...
    public function update(Request $request, string $id): RedirectResponse
    {
        ...
        try {
            ...
            return redirect()
                ->route('admin.campaigns.rewards.index', $reward->campaign->id)
    ...
    public function destroy(Campaign $campaign, Reward $reward): RedirectResponse
    {
        try {
            $reward->delete();
            return redirect()->route('admin.campaigns.rewards.index', $campaign->id)
